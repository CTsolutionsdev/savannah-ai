...
export default function Home() {
  ...
  const renderMode = () => {
    switch (mode) {
      case 'chat':
        return <ChatInterface mode={mode} context={context} />;
      case 'flashcards':
        return <FlashcardView context={context} />;
      case 'quiz':
        return <QuizView context={context} />;
      case 'essay':
        return <EssayOutliner context={context} />;
      case 'casebrief':
        return <CaseBrief context={context} />;
      case 'concept':
        return <ConceptExplainer context={context} />;
      default:
        return <ChatInterface mode="chat" context={context} />;
    }
  };
