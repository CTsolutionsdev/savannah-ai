    ...
    <div className="flex flex-col h-full">
        ...
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-2 text-center max-w-md">
              Enter any concept and adjust the depth slider. I&apos;ll explain it from simple to expert level.
            </p>
            <div className="mt-6 w-full max-w-xs">
              ...
              />
              <p className="text-center text-sm mt-2 text-indigo-600 dark:text-indigo-400 font-medium">
                {['ELI5', 'Beginner', 'Intermediate', 'Advanced', 'Expert'][depth - 1]}
              </p>
            </div>
          </div>
        ) : (
      ...
      {messages.length > 0 && (
        <div className="px-4 py-2 flex items-center justify-center gap-4 border-t border-gray-100 dark:border-gray-900">
          ...
          />
          <span className="text-xs text-indigo-600 dark:text-indigo-400 font-medium w-20">
            {['ELI5', 'Beginner', 'Intermediate', 'Advanced', 'Expert'][depth - 1]}
          </span>
        </div>
      )}
