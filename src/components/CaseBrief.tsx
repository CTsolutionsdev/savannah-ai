    ...
    <div className="flex flex-col h-full">
      ...
      <form onSubmit={handleSubmit} className="border-t border-gray-200 dark:border-gray-800 px-4 py-3">
        <div className="flex gap-2 max-w-3xl mx-auto">
          <input value={input} onChange={handleInputChange} placeholder="Case name or paste case text (e.g. Marbury v. Madison)..." className="flex-1 px-4 py-3 rounded-xl bg-gray-100 dark:bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500" disabled={isLoading} />
