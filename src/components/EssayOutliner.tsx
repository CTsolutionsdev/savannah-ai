    ...
    <div className="flex flex-col h-full">
        ...
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-2 text-center max-w-md">
              Enter your essay topic, prompt, or thesis and I&apos;ll generate a structured outline.
            </p>
          </div>
        ) : (
      ...
      <form onSubmit={handleSubmit} className="border-t border-gray-200 dark:border-gray-800 px-4 py-3">
        <div className="flex gap-2 max-w-3xl mx-auto">
          <input value={input} onChange={handleInputChange} placeholder="Enter essay topic or thesis..." className="flex-1 px-4 py-3 rounded-xl bg-gray-100 dark:bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500" disabled={isLoading} />
